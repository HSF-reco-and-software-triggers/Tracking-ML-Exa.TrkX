...
from LightningModules.GNN.res_agnn import ResAGNN, CheckpointedResAGNN, SplitCheckpointedResAGNN, GNNInferenceCallback
...
# ================================== Filtering ==========================
    ...
    model = SplitCheckpointedResAGNN(config)
